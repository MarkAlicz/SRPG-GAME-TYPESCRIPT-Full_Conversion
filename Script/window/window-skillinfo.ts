...
class SkillInfoWindow extends BaseWindow {
	...
	setSkillInfoData(skill?, objecttype?) {
		this._skill = skill;
		if (this._skill === null) {
	...
	_drawName(x?, y?, skill?, length?, color?, font?) {
	...
	_drawInvocationValue(x?, y?, skill?, length?, color?, font?) {
...
class SkillInfoWindowLong extends SkillInfoWindow {
