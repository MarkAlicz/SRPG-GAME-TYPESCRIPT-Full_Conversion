...
class HpRecoveryEventCommand extends BaseEventCommand {

	_targetUnit: any = null;

	_recoveryValue: any = 0;

	_recoveryWindow: any = null;
...
class RecoveryWindow extends BaseWindow {
