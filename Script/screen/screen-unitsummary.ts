...
class UnitSummaryScreen extends BaseScreen {

	_summaryWindow: any = null;

	_pageChanger: any = null;

	_playerList: any = null;
...
class UnitSummaryWindow extends BaseWindow {

	_scrollbar: any = null;

	setSummaryWindowData() {
...
class UnitSummaryScrollbar extends BaseScrollbar {
	...
	_drawLeft(x?, y?, unit?, isSelect?, index?) {
	...
	_drawRight(x?, y?, unit?, isSelect?, index?) {
		var i, color, range;
