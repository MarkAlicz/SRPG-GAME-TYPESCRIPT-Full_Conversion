...
class SwitchScreen extends BaseScreen {

	_switchWindow: any = null;

	_pageChanger: any = null;

	_isLocalView: any = false;

	_localSwitchArray: any = null;

	_globalSwitchArray: any = null;
	...
	_createSwitchArray(switchArray?, switchTable?) {
		var i, count, data;
	...
	_finishSwitchArray(switchArray?, switchTable?) {
		var i;
	...
	_getGlobalSwitchTable() {
		return root.getMetaSession().getGlobalSwitchTable();
	}
}

class SwitchWindow extends BaseWindow {

	_scrollbar: any = null;

	_objectArray: any = null;

	_switchTable: any = null;

	setSwitchWindowData(switchTable?) {
...
class SwitchScrollbar extends BaseScrollbar {
	...
	_drawSwitch(x?, y?, object?, isSelect?, index?) {
		var color, text;
		var textui = this.getParentTextUI();
		var font = textui.getFont();
