...
class StateItemSelection extends BaseItemSelection {

}

class StateItemUse extends BaseItemUse {
...
class StateItemInfo extends BaseItemInfo {
...
class StateItemPotency extends BaseItemPotency {
...
class StateItemAvailability extends BaseItemAvailability {

}

class StateItemAI extends BaseItemAI {
...
class StateScoreChecker {

	static getScore(unit?, targetUnit?, state?) {
