...
class FusionItemSelection extends BaseItemSelection {
...
class FusionItemUse extends BaseItemUse {
	...
	_doMetamorphozeAction(fusionData?, itemTargetInfo?) {
...
class FusionItemInfo extends BaseItemInfo {
...
class FusionItemPotency extends BaseItemPotency {
...
class FusionItemAvailability extends BaseItemAvailability {
...
class FusionItemAI extends BaseItemAI {
