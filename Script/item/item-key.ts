...
class KeyItemSelection extends BaseItemSelection {
...
class KeyItemUse extends BaseItemUse {
...
class KeyItemInfo extends BaseItemInfo {
...
class KeyItemPotency extends BaseItemPotency {

}

class KeyItemAvailability extends BaseItemAvailability {
...
class KeyItemAI extends BaseItemAI {
